  ...
  tools.polygon = function () {
    ...
    this.mouseup = function (ev) {
      if (ferramenta.started) {
        ...
        document.getElementById("coordenadas_poligono").innerHTML = "<b> Coordenadas X e Y do Polígono com "+edge.value+" vertices: </b>";
...
function download() {
  ...
  element.setAttribute('href', 'data:text/plain;charset=utf-8,' + encodeURIComponent(cordenadas));
